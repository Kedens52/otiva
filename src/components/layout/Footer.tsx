        ...
        <div className="grid gap-8 lg:grid-cols-[260px_1fr]">
          <div>
            ...
            <p className="mt-4 max-w-xs text-sm leading-6 text-zinc-500">
              Отива — маркетплейс для аккуратных сделок, понятных объявлений и быстрого контакта с продавцом.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="mt-5 max-w-3xl text-xs leading-5 text-zinc-400">
              © Отива, 2026. Информация на сайте не является публичной офертой. Используя Отива, вы соглашаетесь с правилами сервиса, политикой конфиденциальности и рекомендациями безопасных сделок.
            </div>
